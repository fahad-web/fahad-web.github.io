...
const UpdateTraveller = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!email || !password || !fastname || !lastname || !contact) {
            ...
            try {
                ...
                const response = await axios.put(process.env.NEXT_PUBLIC_MAIN_URL + '/updatetravelerinfo', user, {
    ...
    return (
        <>
            <Meta title="Update Traveller" keywords="fahad" description="Fahad" />
            <SessionCheck />
            <form className="text-black formcsstravelleradd" onSubmit={handleSubmit}>
                ...
                <label className="texts">ID &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="number" className="text-xs rounded-lg" id="number" name="id" onChange={handleChange} value={id} />
                </label><br></br>
                ...
                <label className="texts ">
                    Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input className="text-black rounded-lg mt-2 text-xs" type="text" id="email" name="email" onChange={handleChange} value={email} />
                </label><br></br>

                <label className="texts">
                    Contact &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input className="text-black rounded-lg mt-2 text-xs" type="number" id="contact" name="contact" onChange={handleChange} value={contact} />
                </label><br></br>

                <label className="texts">
                    Password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input className="text-black rounded-lg mt-2 text-xs" type="text" id="password" name="password" onChange={handleChange} value={password} />
                </label><br></br>
