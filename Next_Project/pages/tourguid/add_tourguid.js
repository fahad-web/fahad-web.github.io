...
const AddTraveller = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(process.env.NEXT_PUBLIC_MAIN_URL + '/register/tourguid', user, {
            ...
            alert("Tourguid Add Successful!");
            router.push('/tourguid/tourguid_list');

        } catch (error) {

            console.error('Error Traveller Signing Up:', error);

            alert("Tourguid Registration Failed!");
    ...
    return (
        <React.Fragment>
            <Meta title="Add Tourguid" keywords="fahad" description="Fahad" />
            <SessionCheck />
            <form className="text-black formcsstravelleradd" onSubmit={handleSubmit}>
                ...
                <label className=" texts">
                    Fast Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input className="text-black rounded-lg mt-3 text-xs" type="text" id="fastname" name="fastname" onChange={handleChange} value={fastname} />
                </label><br></br>

                <label className=" texts">
                    last Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input className="text-black rounded-lg mt-3 text-xs" type="text" id="lastname" name="lastname" onChange={handleChange} value={lastname} />
                </label><br></br>

                <label className=" texts">
                    Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input className="text-black rounded-lg mt-3 text-xs" type="text" id="email" name="email" onChange={handleChange} value={email} />
                </label><br></br>
